...
export default class GameResultWizard extends Component {
    ...
    checkIfGameResultAlreadyExists = (gameId) => {
        this.setState({
            isLoading: true,
            isErrorLoading: false,
        });
        axios.get(localStorage.getItem("host") + "games/result/" + gameId)
            ...
            .then((data) => {
                ...
                if(data.resultSave){
                    this.setState({
                        isMasterTechnicalWin: data.technicalMasterTeamWin,
                        isSlaveTechnicalWin: data.technicalSlaveTeamWin,
                        countMasterGoals: data.masterGoalsCount,
                        countSlaveGoals: data.slaveGoalsCount,
                        countMasterYellowCards: data.masterYellowCardsCount,
                        countSlaveYellowCards: data.slaveYellowCardsCount,
                        countMasterRedCards: data.masterRedCardsCount,
                        countSlaveRedCards: data.slaveRedCardsCount,
                        masterPlayersGoals: data.idsMasterPlayersGoals,
                        slavePlayersGoals: data.idsSlavePlayersGoals,
                        masterPlayersYellowCards: data.idsMasterPlayersYellowCards,
                        slavePlayersYellowCards: data.idsSlavePlayersYellowCards,
                        masterPlayersRedCards: data.idsMasterPlayersRedCards,
                        slavePlayersRedCards: data.idsSlavePlayersRedCards,
                        step:7,
                    });
                }
                this.setState({
    ...
    getPlayersListForGame = (gameId) => {
        ...
        axios.get(localStorage.getItem("host") + "games/" + gameId + "/players")
